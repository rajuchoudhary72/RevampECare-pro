...
sealed interface LoginNavigationGraph : NavKey {
    @Serializable
    data class Login(val schoolCode: String, val isAddAccount: Boolean = false) : LoginNavigationGraph
            ...
            navigateToOtpVerification = { schoolCode, userName, loginResult ->
                backStack.add(
                    LoginNavigationGraph.OtpVerification(
                        ...
                        isAddAccount = navKey.isAddAccount,
                    )
                )
            }
        )
