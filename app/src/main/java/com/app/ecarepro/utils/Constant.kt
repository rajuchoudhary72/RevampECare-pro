...
class Constant {
    companion object {
        ...
        const val SMS_TOKEN_URL = "https://sms.franciscanecare.com/api/Token/Generate"
        const val SMS_BULK_MSG_URL = "https://sms.franciscanecare.com/api/SMSService/BulkSMS"
