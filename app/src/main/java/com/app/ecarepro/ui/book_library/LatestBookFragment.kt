...
@AndroidEntryPoint
class LatestBookFragment(private val latestBook: List<LatestBook>, private val i: Int) : Fragment(),
    ItemListener<LatestBook> {
    ...
    override fun onItemClick(t: LatestBook, pos: Int, boolean: Boolean) {
        findNavController().navigate(
            R.id.action_bookLibraryFragment_to_bookDetailsFragment,
            Bundle().apply {
