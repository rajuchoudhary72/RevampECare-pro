...
class QuestionnaireAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionnaireViewHolder {
        bindingm =
            QuestionnaireListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: QuestionnaireViewHolder, position: Int) {
        ...
        holder.total_like.text =
            data.likes.toString() + " " + questionnaireListFragment.getString(R.string.like)
        holder.tv_total_answer.text =
            data.totalAnswer.toString() + " " + questionnaireListFragment.getString(R.string.answer)


        Picasso.get().load(questionsList[position].photo).placeholder(R.drawable.default_profile)
        ...
        holder.unlike.setOnClickListener {
            ...
            setLikeDisLikeUi(like, holder)
            holder.total_like.text =
                "$likeCount" + " " + questionnaireListFragment.getString(R.string.like)
        }
