...
class AssignStudentSelectAdapter(
    ...
    RecyclerView.Adapter<AssignStudentSelectAdapter.AssignStudentSelectHolder>() {
    private var lastIndex = -1

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AssignStudentSelectHolder {
        val mBinding =
            ItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return AssignStudentSelectHolder(mBinding)
    }

    override fun getItemCount(): Int = studentMutableList.size

    override fun onBindViewHolder(holder: AssignStudentSelectHolder, position: Int) {
    ...
    class AssignStudentSelectHolder(itemView: ItemBinding) :
