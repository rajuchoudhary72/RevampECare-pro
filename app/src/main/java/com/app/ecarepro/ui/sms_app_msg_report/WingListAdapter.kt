...
class WingListAdapter(
    private var academicYearList: List<WingLST>,
    private val selectAll: Boolean,
    private val multiSelect: Boolean,

    private var itemListener: ItemListener<WingLST>
) :
    RecyclerView.Adapter<WingListAdapter.PopUpListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PopUpListViewHolder, pos: Int) {
        ...
        holder.itemName.text=academicYearList[holder.bindingAdapterPosition].wingName
