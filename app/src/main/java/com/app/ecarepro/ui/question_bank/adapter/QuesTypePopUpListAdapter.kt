...
class QuesTypePopUpListAdapter(private var infractionTypeList: List<QuestionType>,
                               private var itemListener: ItemListener<QuestionType>
) :
    RecyclerView.Adapter<QuesTypePopUpListAdapter.PopUpListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PopUpListViewHolder, pos: Int) {
        ...
        holder.itemName.text=infractionTypeList[holder.bindingAdapterPosition].queType
