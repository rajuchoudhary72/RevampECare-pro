...
class AssignmentNavHostViewModel @Inject constructor(
    ...
    private val assignmentMutableStateFlow: MutableStateFlow<NetworkResult<NetworkAssignments>> =
        MutableStateFlow(
            NetworkResult.Loading()
        )
    val assignmentStateFlow: StateFlow<NetworkResult<NetworkAssignments>> =
        assignmentMutableStateFlow
