...
class CustomDropDownAdapterMonth(val context: Context, private var listItemsTxt: List<MonthlyPaySlip>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = listItemsTxt[position].month
        return view
    }
