...
class MedicineCardViewModel @Inject constructor(
    ...
    private val studentMedicalCardResponse: MutableStateFlow<NetworkResult<StudentMedicalCardResponse>> = MutableStateFlow(
        NetworkResult.Loading())
    val _studentMedicalCardResponse: StateFlow<NetworkResult<StudentMedicalCardResponse>> = studentMedicalCardResponse
    fun  getMedicalCard(
        id: String
    )=viewModelScope.launch {
        runCatching {
