...
class SessionsMobileListAdapter(
    private val appSessions: List<AppSession>,
    private val userSessionListFragment: UserSessionListFragment
) :
    RecyclerView.Adapter<SessionsMobileListAdapter.SmsReportViewHolder>() {
    ...
    override fun getItemCount(): Int = appSessions.size
