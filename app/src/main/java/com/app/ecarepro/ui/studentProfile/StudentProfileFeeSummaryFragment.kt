...
class StudentProfileFeeSummaryFragment(private val feeSummery: FeeSummery) : Fragment() {
        ...
        with(binding) {
            ...
            if (feeSummery.feeInstallment!=null){
                val assignmentListAdapter =
                    StudentProfileFeeSummeryAdapter(feeSummery.feeInstallment,
                ...
                binding.rvFeePaid.isVisible=true
                binding.tvNoData.isVisible=false


            }else{
                binding.rvFeePaid.isVisible=false
                binding.tvNoData.isVisible=true

            }

            tvAllPaidHistory.setOnClickListener {
                if (feeSummery.paidHistory!=null){
