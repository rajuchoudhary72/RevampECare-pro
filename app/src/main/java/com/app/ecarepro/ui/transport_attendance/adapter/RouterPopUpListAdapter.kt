...
class RouterPopUpListAdapter(private var routeLSTList: List<RouteLST>,
                             private var itemListener: ItemListener<RouteLST>
) :
    RecyclerView.Adapter<RouterPopUpListAdapter.PopUpListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PopUpListViewHolder, pos: Int) {
        ...
        holder.itemName.text=routeLSTList[holder.bindingAdapterPosition].routeName
