...
class SubjectsClassPopUpListAdapter(private var infractionTypeList: List<Subject>,
                                    private var itemListener: ItemListener<Subject>
) :
    RecyclerView.Adapter<SubjectsClassPopUpListAdapter.PopUpListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PopUpListViewHolder, pos: Int) {
        ...
        holder.itemName.text=infractionTypeList[holder.bindingAdapterPosition].subjectName
