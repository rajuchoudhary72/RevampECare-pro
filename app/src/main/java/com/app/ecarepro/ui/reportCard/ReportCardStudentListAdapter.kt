...
class ReportCardStudentListAdapter(private var studentList: List<Student>,
                                   private var studentListFragment: ReportCardStudentListFragment
) :
    RecyclerView.Adapter<ReportCardStudentListAdapter.CircularViewHolder>() {
