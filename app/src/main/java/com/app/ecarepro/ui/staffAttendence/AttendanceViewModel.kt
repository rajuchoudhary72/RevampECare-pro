...
class AttendanceViewModel @Inject constructor(
    ...
    private val staffAttendenceMutableStateFlow: MutableStateFlow<NetworkResult<NetworkStaffAttendence>> = MutableStateFlow(
        NetworkResult.Loading())
    val staffAttendenceStateFlow: StateFlow<NetworkResult<NetworkStaffAttendence>> = staffAttendenceMutableStateFlow
