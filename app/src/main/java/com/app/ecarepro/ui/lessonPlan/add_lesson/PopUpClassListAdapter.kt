...
class PopUpClassListAdapter(private var mySubjectList: List<MyClasseItem>,
                            private var itemListener: ItemListener<MyClasseItem>
) :
    RecyclerView.Adapter<PopUpClassListAdapter.PopUpListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PopUpListViewHolder, pos: Int) {
        ...
        holder.itemName.text=mySubjectList[holder.bindingAdapterPosition].className
