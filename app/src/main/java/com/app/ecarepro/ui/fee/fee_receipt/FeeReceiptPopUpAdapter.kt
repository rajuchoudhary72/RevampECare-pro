...
class FeeReceiptPopUpAdapter(private var routeLSTList: List<FeeReceiptSession>,
                             private var itemListener: ItemListener<FeeReceiptSession>
) :
    RecyclerView.Adapter<FeeReceiptPopUpAdapter.PopUpListViewHolder>() {
