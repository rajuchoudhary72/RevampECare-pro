...
class LeaveSettingDetailsAdapter(
    private var leaveDetailList: List<LeaveDetail>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeaveHistoryViewHolder {
        binding =
            LeaveSettingListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
