...
class ClassPopUpListAdapter(private var infractionTypeList: List<MyClasse>,
                            private var itemListener: ItemListener<MyClasse>
) :
    RecyclerView.Adapter<ClassPopUpListAdapter.PopUpListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PopUpListViewHolder, pos: Int) {
        ...
        holder.itemName.text=infractionTypeList[holder.bindingAdapterPosition].className
