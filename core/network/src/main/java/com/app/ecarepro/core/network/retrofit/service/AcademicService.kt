...
import com.app.ecarepro.core.network.model.activity_calendar.NetworkActivityCalendarResponse
...
interface AcademicService {
    ...
    @GET("Academic/ActivityCaledar")  // Note: API typo preserved
    suspend fun getActivityCalendar(): NetworkActivityCalendarResponse

    @GET("Academic/QuestionPaper")
    suspend fun getQuestionPapers(
        @Query("classID") classId: Int,
        @Query("yrID") yrId: Int,
    ): com.app.ecarepro.core.network.model.academic.NetworkQuestionPaperResponse
}