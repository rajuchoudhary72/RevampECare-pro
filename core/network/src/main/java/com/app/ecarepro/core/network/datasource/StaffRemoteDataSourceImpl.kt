...
internal class StaffRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun getClassTeacherOf(): List<NetworkClass> {
        return staffService.getClassTeacherOf().unwrapPayload { myClasses }
    }
    ...
    override suspend fun getTeacherList(): List<NetworkStaffProfile> {
        return staffService.getTeacherList().unwrapPayload { staff ?: emptyList() }
    }
