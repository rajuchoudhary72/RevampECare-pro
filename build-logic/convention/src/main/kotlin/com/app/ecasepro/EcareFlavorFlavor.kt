...
@Suppress("EnumEntryName")
enum class EcareFlavor(val dimension: FlavorDimension, val applicationIdSuffix: String? = null) {
...
fun configureFlavors(
    ...
    flavorConfigurationBlock: ProductFlavor.(flavor: EcareFlavor) -> Unit = {},
) {
    commonExtension.apply {
        ...
        productFlavors {
            EcareFlavor.values().forEach { niaFlavor ->
